...
import org.xmuyoo.blueberry.crawling.domains.SeriesData;
import org.xmuyoo.blueberry.crawling.domains.StockCode;
import org.xmuyoo.blueberry.crawling.domains.StockRealtimePrice;
import org.xmuyoo.blueberry.crawling.http.Request;
import org.xmuyoo.blueberry.crawling.http.Requests;
import org.xmuyoo.blueberry.crawling.streams.Publisher;
import org.xmuyoo.blueberry.crawling.utils.Utils;
...
@Slf4j
public class StockCrawler extends SimpleBatchCrawler {
    ...
    private int crawlerPeriodMinutes;
    ...
    public StockCrawler() {
        ...
        ThreadFactory factory =
                new ThreadFactoryBuilder().setNameFormat("stock-crawler-%s").build();
        ...
        this.crawlerPeriodMinutes = config.getInt(PERIOD_MINUTES);
    ...
    public void run() {
        while (isRunning) {
            if (null == stockCodes || stockCodes.isEmpty()) {
                waitMinutes(crawlerPeriodMinutes);
            }
